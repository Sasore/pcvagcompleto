 ...
 */
public class GeneticTestsBinaryCrossover {
    ...
    @Test
    public void testCrossoverCX() {

        Rota[] rotasPais = this.getRotas();

        System.out.println("Cruzar rota 0 = " + rotasPais[0]);
        System.out.println("Cruzar rota 1 = " + rotasPais[1]);

        Rota[] rotasFilhas = testCrossoverCXRotas(rotasPais[0],rotasPais[1]);

        System.out.println("Rota filha 0 = " + rotasFilhas[0]);
        System.out.println("Rota filha 1 = " + rotasFilhas[1]);
